...
![Cài extension](images/vscode-mysql-images/vscode-01.jpg)

3. Mở Explorer (Ctrl+Shift+E) - mục MySQL sẽ xuất hiện. Nhấn `Add Connection` để tạo kết nối mới.

![Add Connection](images/vscode-mysql-images/vscode-02.jpg)
...
![Authentication error](images/vscode-mysql-images/vscode-03.jpg)

6. Mở thư mục cài đặt MySQL, vào `bin`, rồi mở `cmd` tại đó nếu cần thao tác trực tiếp.

![Open bin folder](images/vscode-mysql-images/vscode-04.jpg)
...
![Client connect](images/vscode-mysql-images/vscode-06.jpg)
...
![Flush privileges](images/vscode-mysql-images/vscode-07.jpg)

## Thay đổi kết nối trong VS Code

1. Xoá kết nối cũ.

![Delete connection](images/vscode-mysql-images/vscode-08.jpg)
...
![Query results](images/vscode-mysql-images/vscode-09.jpg)
...
![Refresh and results](images/vscode-mysql-images/vscode-11.jpg)
