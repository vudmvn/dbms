...
![Lỗi thiếu tham số](images/command-options-images/command-options-02.png)

Mở tab `Users and Privileges` trong MySQL Workbench:

![Users and Privileges](images/command-options-images/command-options-01.png)

Kết nối bằng tài khoản `root` (ví dụ):

![Kết nối bằng root](images/command-options-images/command-options-03.png)
