...
![Bước 1 - Truy cập trang MySQL](images/mysql-install-images/mysql-01.webp)
...
![Bước 2 - Bỏ qua đăng nhập và tải ngay](images/mysql-install-images/mysql-02.webp)

### Bước 3. Chạy file cài đặt

Sau khi tải xong, mở thư mục `Downloads`, tìm file `.exe` vừa tải về và nhấp đúp để chạy trình cài đặt.

![Bước 3 - Chạy bộ cài](images/mysql-install-images/mysql-03.webp)
...
![Bước 5 - Kiểm tra thành phần phụ thuộc](images/mysql-install-images/mysql-04.webp)
...
![Bước 6 - Tải thành phần](images/mysql-install-images/mysql-05.webp)

### Bước 7. Cài đặt các gói đã tải

Tiếp tục nhấn `Execute` để cài các thành phần đã tải xuống vào máy tính.

![Bước 7 - Cài đặt thành phần](images/mysql-install-images/mysql-06.webp)
...
![Bước 9 - Tạo mật khẩu root](images/mysql-install-images/mysql-07.webp)
...
![Bước 10 - Kiểm tra kết nối](images/mysql-install-images/mysql-08.webp)

### Bước 11. Hoàn tất cài đặt

Khi cài đặt xong, chọn `Finish` để kết thúc trình cài đặt.

![Bước 11 - Hoàn tất cài đặt](images/mysql-install-images/mysql-09.webp)
...
![Bước 12 - MySQL Workbench sẵn sàng sử dụng](images/mysql-install-images/mysql-10.webp)
